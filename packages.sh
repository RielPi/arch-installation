...
# "essenstials"
sudo pacman -S alacritty alsa-utils dunst curl htop hunspell{-es_any,-en_US} gnupg libmpt playerctl neovim numlockx screenfetch ufw gufw wget zsh zsh-completions zip xclip xdotool xsel xwallpaper
# fonts
