...
# "essenstials"
sudo pacman -S alacritty alsa-utils dunst curl htop hunspell{-es_any,-en_US} gnupg libmpt lsd playerctl neovim numlockx screenfetch ufw gufw wget zsh zsh-completions zip xclip xdotool xsel xwallpaper
# fonts
...
sudo pacman -S arc-gtk-theme kvantum-qt5 papirus-icon-theme 
...
# audio
sudo pacman -S ffmpeg pipewire pipewire-alsa pipewire-pulse pulsemixer

# packages
sudo pacman -S anki mpv firefox network-manager-applet flameshot foliate discord redshift rofi rofimoji network-manager-applet
